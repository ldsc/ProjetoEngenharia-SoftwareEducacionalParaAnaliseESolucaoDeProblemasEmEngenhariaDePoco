...
public:
    ...
    void setupUi(QDialog *CJanelaGraficoPressaoHidroestatica)
    {
        if (CJanelaGraficoPressaoHidroestatica->objectName().isEmpty())
            CJanelaGraficoPressaoHidroestatica->setObjectName(QString::fromUtf8("CJanelaGraficoPressaoHidroestatica"));
...
"}"));
        ...
        customPlotPressaoMediaProfundidade->setObjectName(QString::fromUtf8("customPlotPressaoMediaProfundidade"));
        ...
        BntnExportarGrafico->setObjectName(QString::fromUtf8("BntnExportarGrafico"));
