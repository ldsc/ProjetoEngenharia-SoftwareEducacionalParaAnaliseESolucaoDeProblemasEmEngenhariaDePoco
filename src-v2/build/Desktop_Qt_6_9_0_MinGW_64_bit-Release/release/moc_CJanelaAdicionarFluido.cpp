...
template <> constexpr inline auto janelaadicionarfluido::qt_create_metaobjectdata<qt_meta_tag_ZN21janelaadicionarfluidoE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<janelaadicionarfluido, qt_meta_tag_ZN21janelaadicionarfluidoE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject janelaadicionarfluido::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21janelaadicionarfluidoE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21janelaadicionarfluidoE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN21janelaadicionarfluidoE_t>.metaTypes,
    nullptr
} };
...
void *janelaadicionarfluido::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21janelaadicionarfluidoE_t>.strings))
