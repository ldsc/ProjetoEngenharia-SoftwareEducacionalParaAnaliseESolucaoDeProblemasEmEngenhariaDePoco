...
"border-radius: 5px;"));
        ...
        lbnTituloProfundidadePacker_5->setObjectName("lbnTituloProfundidadePacker_5");
...
"border-radius: 5px;"));
        ...
        editPressaoSupInicial->setObjectName("editPressaoSupInicial");
...
"border-radius: 5px;"));
        ...
        editPressaoSupFinal->setObjectName("editPressaoSupFinal");
...
"}"));
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::LabelRole, lbnTituloProfundidadePacker_3);
...
"border-radius: 5px;"));
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, editProfundidadeMedicao);

        verticalSpacer_7 = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        formLayout->setItem(2, QFormLayout::ItemRole::SpanningRole, verticalSpacer_7);
        ...
        formLayout->setWidget(3, QFormLayout::ItemRole::LabelRole, lbnTituloNomePoco_2);
        ...
        formLayout->setWidget(3, QFormLayout::ItemRole::FieldRole, lbnPressaoHidroestatica);
        ...
        formLayout->setWidget(4, QFormLayout::ItemRole::LabelRole, lbnTituloNomePoco_3);
        ...
        formLayout->setWidget(4, QFormLayout::ItemRole::FieldRole, lbnCargaInicial);
        ...
        formLayout->setWidget(5, QFormLayout::ItemRole::LabelRole, lbnTituloNomePoco_11);

        lbnCargaInjecaoColunaFixa = new QLabel(layoutWidget1);
        lbnCargaInjecaoColunaFixa->setObjectName("lbnCargaInjecaoColunaFixa");
        lbnCargaInjecaoColunaFixa->setFont(font1);
        lbnCargaInjecaoColunaFixa->setAlignment(Qt::AlignmentFlag::AlignCenter);

        formLayout->setWidget(5, QFormLayout::ItemRole::FieldRole, lbnCargaInjecaoColunaFixa);
        ...
        formLayout->setWidget(6, QFormLayout::ItemRole::LabelRole, lbnTituloNomePoco_8);
        ...
        formLayout->setWidget(6, QFormLayout::ItemRole::FieldRole, lbnCargaInjecaoColunaLivre);

        verticalSpacer_9 = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        formLayout->setItem(8, QFormLayout::ItemRole::SpanningRole, verticalSpacer_9);
        ...
        formLayout->setWidget(9, QFormLayout::ItemRole::LabelRole, lbnTituloDeltaTemperatura);
        ...
        formLayout->setWidget(9, QFormLayout::ItemRole::FieldRole, lbnTituloDeltaLTemperatura);
        ...
        formLayout->setWidget(10, QFormLayout::ItemRole::LabelRole, lbnTituloNomePoco_5);
        ...
        formLayout->setWidget(10, QFormLayout::ItemRole::FieldRole, lbnTituloDeltaLBalao);
        ...
        formLayout->setWidget(11, QFormLayout::ItemRole::LabelRole, lbnTituloNomePoco_6);
        ...
        formLayout->setWidget(11, QFormLayout::ItemRole::FieldRole, lbnDeltaLPistaoPacker);
        ...
        formLayout->setWidget(12, QFormLayout::ItemRole::LabelRole, lbnTituloNomePoco_7);
        ...
        formLayout->setWidget(12, QFormLayout::ItemRole::FieldRole, lbnDeltaLPistaoCrossover);
        ...
        formLayout->setWidget(13, QFormLayout::ItemRole::LabelRole, lbnTituloNomePoco_10);
        ...
        formLayout->setWidget(13, QFormLayout::ItemRole::FieldRole, lbnDeltaLForcaRestauradora);

        verticalSpacer_8 = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        formLayout->setItem(14, QFormLayout::ItemRole::SpanningRole, verticalSpacer_8);
        ...
        formLayout->setLayout(15, QFormLayout::ItemRole::SpanningRole, horizontalLayout);
