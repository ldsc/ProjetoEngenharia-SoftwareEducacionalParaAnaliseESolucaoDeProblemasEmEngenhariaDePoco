...
public:
    ...
    void setupUi(QMainWindow *CSimuladorReologico)
    {
        ...
        QIcon icon2(QIcon::fromTheme(QString::fromUtf8("QIcon::ThemeIcon::Printer")));
        ...
        QIcon icon4(QIcon::fromTheme(QString::fromUtf8("QIcon::ThemeIcon::HelpFaq")));
        ...
        QIcon icon6(QIcon::fromTheme(QString::fromUtf8("QIcon::ThemeIcon::HelpAbout")));
