...
public:
 ...
 //---------------------------------------------------------------------------------Construtores
  ...
  ////////////////////////////////// Novidades Bueno ////////////////////////////////////////
  /// Seta uma mensagem numa determinada posi��o (requer a chamada a Replot())
  ...
  /// Seta uma mensagem numa determinada posi��o e j� chama Replot()
  ...
  /// Seta um ponto numa determinada posi��o (requer a chamada a Replot())
  Gnuplot & SetPoint(double x, double y) {
      //*this << "plot '-' w p ls 1, \n" << std::to_string(x) << " " <<  std::to_string(y) << "\ne\n";
      SetLabel( x,y,"*");
      return *this;      
  }
  /// Plota um ponto numa determinada posi��o e j� chama Replot()
  ...
  /// Seta uma seta numa determinada posi��o
  ...
  /// Seta uma seta numa determinada posi��o e j� chama Replot()
  ...
  /// Exporta gr�fico no formato de uma imagem (FALTA TESTAR!).
  ...
  // 
  /// Sobrecarga do operador de inser��o << ; uso: vector<double> vx,vy; grafico << make_pair(vx,vy);
